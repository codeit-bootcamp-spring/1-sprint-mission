...
public class MessageFactory {
    ...
    private static final MessageService MESSAGE_SERVICE = new JCFMessageService(MESSAGE_REPOSITORY,
            ChannelFactory.getChannelService(), UserFactory.getUserService());
    ...
    public static MessageRepository createMessageRepository() {
        ...
        try {
            properties.load(new FileInputStream("application.yml"));
        } catch (IOException e) {
