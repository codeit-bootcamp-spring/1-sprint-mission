...
public class ChannelServiceImpl implements ChannelService {
  ...
  public Channel createPrivateChannel(PrivateChannelCreateDTO request) {
    ...
    userIdList.forEach(userId -> {
      ReadStatusCreateRequest readStatusCreateDTO = new ReadStatusCreateRequest(userId,
          createdChannel.getId(), createdChannel.getCreatedAt());
  ...
  public List<ChannelDto> findAllByUserId(UUID userId) {
    ...
    List<ChannelDto> privateChannelDTOList = channelRepository.findAllPrivateChannelByUserId(
        userId);
