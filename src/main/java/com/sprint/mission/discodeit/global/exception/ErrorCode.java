...
public enum ErrorCode {
  ...
  USER_EMAIL_ALREADY_EXIST(HttpStatus.CONFLICT, "USER007", "이미 사용중인 이메일입니다."),
  USER_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "USER003", "사용자명은 비워둘 수 없습니다."),
  USER_NAME_TOO_SHORT(HttpStatus.BAD_REQUEST, "USER004", "사용자명은 최소 2글자 입니다."),
  USER_NAME_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "USER005", "이미 사용중인 사용자명입니다."),
  USER_EMAIL_FORMAT_NOT_MATCH(HttpStatus.BAD_REQUEST, "USER006", "이메일 형식에 맞지 않습니다."),
  USER_PASSWORD_REQUIRED(HttpStatus.BAD_REQUEST, "USER008", "비밀번호는 비워둘 수 없습니다."),
  USER_PASSWORD_TOO_SHORT(HttpStatus.BAD_REQUEST, "USER009", "비밀번호는 최소 6글자 입니다."),

  // CHANNEL
  CHANNEL_NOT_FOUND(HttpStatus.NOT_FOUND, "CHANNEL001", "해당 채널이 존재하지 않습니다."),
  CHANNEL_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "CHANNEL002", "채널 이름은 비워둘 수 없습니다."),
  PRIVATE_CHANNEL_CANNOT_BE_MODIFIED(HttpStatus.BAD_REQUEST, "CHANNEL003",
      "Private 채널은 수정될 수 없습니다."),

  // MESSAGE
  MESSAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "MESSAGE001", "해당 메세지가 존재하지 않습니다."),
  MESSAGE_CONTENT_REQUIRED(HttpStatus.BAD_REQUEST, "MESSAGE002", "메세지 내용을 비워둘 수 없습니다."),
  ...
  BINARY_STORAGE_INIT_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "BINARY002", "바이너리 저장소 초기화에 실패했습니다."),
