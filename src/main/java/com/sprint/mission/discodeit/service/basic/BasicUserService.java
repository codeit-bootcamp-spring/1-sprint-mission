...
public class BasicUserService implements UserService {
	...
	public UserDto create(UserCreateRequest userCreateRequest,
		...
		log.info("Creating user: username={}, email={}", userCreateRequest.username(), userCreateRequest.email());
		...
		BinaryContent nullableProfile = optionalProfileCreateRequest
			.map(profileRequest -> {
				log.debug("Processing profile picture: {}", profileRequest.fileName());
	...
	public UserDto update(UUID userId, UserUpdateRequest userUpdateRequest,
		Optional<BinaryContentCreateRequest> optionalProfileCreateRequest) {
		log.info("Updating user: id={} with newUsername={}, newEmail={}", userId, userUpdateRequest.newUsername(),
