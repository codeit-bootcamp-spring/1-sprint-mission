...
public class BasicUserService implements UserService {
  ...
  @Override
  public UserResponse createUserWithProfileImage(UserCreateRequest userRequest,
  ...
  @Override
  public UserResponse updateUserWithProfileImage(UUID userId, UserUpdateRequest userRequest,
      BinaryContentCreateRequest imageRequest) {
    User user = userRepository.findById(userId);
    if (user == null) {
      return null;
    ...
    if (userRequest.newUsername() != null) {
      user.updateUsername(userRequest.newUsername());
    }
    if (userRequest.newEmail() != null) {
      user.updateEmail(userRequest.newEmail());
    }
    if (userRequest.newPassword() != null) {
      user.updatePassword(userRequest.newPassword());
    }
