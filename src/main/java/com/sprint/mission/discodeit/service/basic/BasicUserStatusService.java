...
public class BasicUserStatusService implements UserStatusService {
  ...
  public UserStatus create(UserStatusCreateRequest request) {
    ...
    if (userStatusRepository.findByUserId(userId).isPresent()) {
      throw new UserStatusAlreadyExistException("UserStatus with id " + userId + " already exists");
    }

    Instant lastActiveAt = request.lastActiveAt();
    UserStatus userStatus = UserStatus.createUserStatus(userId, lastActiveAt);
  ...
  public UserStatus updateByUserId(UUID userId, UserStatusUpdateRequest request) {
    ...
    UserStatus updatedUserStatus = userStatus.update(newLastActiveAt);
