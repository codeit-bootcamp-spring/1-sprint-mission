...
public class LocalBinaryContentStorage implements BinaryContentStorage {
  ...
  public void init() throws IOException {
    try {
      ...
      throw new RestApiException(DomainErrorCode.STORAGE_FAILED, "저장소 초기화 실패");
    }
  }
  ...
  public UUID put(UUID id, byte[] data) throws IOException {
    try {
      ...
      throw new RestApiException(DomainErrorCode.STORAGE_NOT_SAVE, "파일 저장 실패");
    }
  }
  ...
  public ResponseEntity<?> download(BinaryContentDto binaryContentDto) throws IOException {
    try {
      ...
      throw new RestApiException(DomainErrorCode.STORAGE_NOT_DOWNLOAD, "파일 다운로드 실패");
    }
  }
