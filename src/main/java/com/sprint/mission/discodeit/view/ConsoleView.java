...
public class ConsoleView {
  ...
  public void displayMessages(List<Message> messages, List<Channel> channels,
    ...
    if (!messages.isEmpty()) {
      for (Message message : messages) {
        ...
        UserResponse user = userService.getUserById(message.getAuthorId());
