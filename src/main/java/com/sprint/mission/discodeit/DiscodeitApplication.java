...
public class DiscodeitApplication {
    ...
    public static void main(String[] args) {
        ...
        userService.update(jcfUserOne.getId(), new User("Bob", "updated_user1@example.com", "010-2349-9548", "Seoul, Korea", 35, "Reading2", new ArrayList<>(List.of("Construction","Technology", "Gaming"))));
        jcfUserOne = userService.searchByUserId(jcfUserOne.getId());
        ...
        System.out.println("====== file Repo 교체 =====");
