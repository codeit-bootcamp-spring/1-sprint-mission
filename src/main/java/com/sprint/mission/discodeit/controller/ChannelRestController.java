...
public class ChannelRestController {
    ...
    @GetMapping("/{id}")
    public ChannelResponse findByChannel(@PathVariable UUID id){ return channelService.readOne(id); }
    ...
    public ChannelResponse findByPublicChannel(@PathVariable UUID id) { return channelService.publicChannelReadOne(id); }
