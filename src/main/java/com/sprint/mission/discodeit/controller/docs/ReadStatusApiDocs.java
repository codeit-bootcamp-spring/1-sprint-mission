...
public interface ReadStatusApiDocs {
  ...
  ResponseEntity<CustomApiResponse<ReadStatusResponse>> createReadStatus(
  ...
  ResponseEntity<CustomApiResponse<ReadStatusResponse>> updateReadStatus(
  ...
  ResponseEntity<CustomApiResponse<List<ReadStatusResponse>>> getReadStatusByUser(UUID userId);
}
