...
public interface MessageApi {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "404", description = "Channel 또는 User를 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "Channel | Author not found: {channelId | authorId}")))})
  ResponseEntity<MessageDto> createMessage(
      ...
      @Parameter(description = "Message 첨부 파일들", content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE)) List<MultipartFile> attachments);
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "404", description = "Message를 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "Message not found: {messageId}")))})
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Message가 성공적으로 삭제됨"),
      @ApiResponse(responseCode = "404", description = "Message를 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "Message not found: {messageId}")))})
  ResponseEntity<Void> deleteMessage(@Parameter(description = "삭제할 Message ID") UUID messageId);
