...
public interface BinaryContentApi {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "404", description = "첨부 파일을 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "BinaryContent not found: BinaryContentId = {binaryContentId}")))})
