...
public interface ReadStatusApi {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "404", description = "Channel 또는 User를 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "Channel | User not found: {channelId | userId}"))),
      @ApiResponse(responseCode = "400", description = "이미 읽음 상태가 존재함", content = @Content(examples = @ExampleObject(value = "ReadStatus already exists: userId = {userId}, channelId = {channelId}")))})
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "404", description = "Message 읽음 상태를 찾을 수 없음", content = @Content(examples = @ExampleObject(value = "ReadStatus not found: {readStatusId}")))})
