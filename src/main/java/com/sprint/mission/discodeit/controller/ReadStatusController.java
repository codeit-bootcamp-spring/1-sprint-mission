...
public class ReadStatusController {
    ...
    // 메시지 수신 정보 생성
    @PostMapping
    public ResponseEntity<ReadStatusDto> createReadStatus(@RequestBody ReadStatusCreateRequest readStatusCreateRequest) {
    ...
    public ResponseEntity<List<ReadStatusDto>> searchAllReadStatusesByUserId(@PathVariable UUID userId) {
