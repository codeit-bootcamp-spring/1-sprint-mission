...
@Tag(name = "BinaryContent", description = "바이터리 파일 조회 API")
public interface BinaryContentApi {

  @Operation(summary = "바이터리 파일 조회")
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200", description = "바이터리 파일 조회 성공",
  ...
  @Operation(summary = "여러 바이터리 파일 조회")
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200", description = "바이터리 파일 조회 성공",
