...
public class FileMessageRepository implements MessageRepository {
  ...
  /**
   * [ ]  JCF 대신 FileIO와 객체 직렬화를 활용해 메소드를 구현하세요. JCF 이용하지 않고, 각 도메인 모델 이름(users, chnnels, messages)을
   * 딴 폴더에 ser파일을 개별 객체로 저장합니다.
   **/
  ...
  public FileMessageRepository() {
    ...
    this.MESSAGES_PATH = Paths.get(System.getProperty("user.dir"), "file-data-map", "crs",
