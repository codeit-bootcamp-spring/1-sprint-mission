...
public class GlobalExceptionHandler {
	...
	private HttpStatus determineHttpStatus(DiscodeitException exception) {
		...
		return switch (errorCode) {
			...
			case INVALID_USER_CREDENTIALS, INVALID_TOKEN, TOKEN_NOT_FOUND, INVALID_TOKEN_SECRET -> HttpStatus.UNAUTHORIZED;
			case PRIVATE_CHANNEL_UPDATE, INVALID_REQUEST -> HttpStatus.BAD_REQUEST;
			case INTERNAL_SERVER_ERROR, UPLOAD_FAILED -> HttpStatus.INTERNAL_SERVER_ERROR;
		};
	}
}
