...
public class CommonResponse<T> {
  ...
  public static ResponseEntity<CommonResponse> toResponseEntity(HttpStatus status, String message,
      Object data) {
  ...
  public static ResponseEntity<CommonResponse> toResponseEntityWithoutData(HttpStatus status,
      String message) {
    return ResponseEntity
        .status(status)
        .body(CommonResponse.builder()
