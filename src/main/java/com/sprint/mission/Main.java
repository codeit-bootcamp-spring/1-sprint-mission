...
import com.sprint.mission.discodit.Factory;
...
public class Main {
    public static void main(String[] args) {
        ...
        userService.setUser(user1, "Park");
        System.out.println(userService.getUser(user1));
        System.out.println("====================================================");
        ...
        channelService.setChannel(channel2, "EBS");
        ...
        List<Message> messageByUserId = messageService.getMessageByUserId(user3);
        System.out.println("messageByUserId = " + messageByUserId);
        System.out.println("====================================================");
        System.out.println("유저 삭제 시 메시지 삭제");
        userService.deleteUser(user3);
        messageByUserId = messageService.getMessageByUserId(user3);
        System.out.println("messageByUserId = " + messageByUserId);
        System.out.println("====================================================");
