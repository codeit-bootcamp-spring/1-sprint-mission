...
public class JavaApplication {
    ...
    public static void fileServiceTest(){
        ...
        //수정
        fileUserService.updateUser(userId1, "edit_name", "edit_email@naver.com");
        System.out.println();
        ...
        //수정
        fileChannelService.updateChannel(channelId1, "수정한 채널 1이름", "수정한 채런 설명 1", ChannelType.PUBLIC);
    ...
    public static void jcfServiceTest(){
        ...
        //수정
        jcfUserService.updateUser(userId1, "edit_name", "edit_email@naver.com");
        System.out.println();
        ...
        //수정
        jcfChannelService.updateChannel(channelId1, "수정한 채널 1이름", "수정한 채런 설명 1", ChannelType.PUBLIC);
