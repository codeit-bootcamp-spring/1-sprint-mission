...
import com.sprint.misson.discodeit.dto.user.CreateUserDto;
import com.sprint.misson.discodeit.entity.*;
import com.sprint.misson.discodeit.factory.service.BasicServiceFactory;
import com.sprint.misson.discodeit.factory.service.ServiceFactory;
...
import com.sprint.misson.discodeit.service.file.FileService;
...
public class JavaApplication {
    ...
    public static void main(String[] args) {
        ...
        User notExistUser = new User("없는유저", "noOne@test.com", "hello", "없는 유저 상태", null, AccountStatus.UNVERIFIED);
