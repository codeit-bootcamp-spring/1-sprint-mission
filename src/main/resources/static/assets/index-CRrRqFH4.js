...
function qm() {
  ...
  function se(S, D, oe) {
    var le, de = {},
        ...
        ve = null;
    if (D != null) {
      for (le in D.ref !== void 0 && (ve = D.ref), D.key !== void 0 && (ce = ""
          + D.key), D) {
  ...
  function at(S, D, oe, le, de) {
    ...
    if (ve = 0, le = le === "" ? "." : le + ":", K(S)) {
      ...
      for (S = ge.call(S), pe = 0;
          !(ce = S.next()).done;) {
        ce = ce.value, ge = le + Je(ce,
            pe++), ve += at(ce, D, oe, ge, de);
      }
    } else if (ce === "object") {
      throw D = String(S), Error(
          "Objects are not valid as a React child (found: " + (D
    ...
    function W(Q) {
      for (var ee = s(x); ee !== null;) {
        if (ee.callback === null) {
          ...
          u(x), ee.sortIndex = ee.expirationTime, i(v,
              ee);
        } else {
          break;
        }
...
` + l[f].replace(" at new ", " at ");
                  ...
                  && (y = y.replace("<anonymous>", e.displayName)), y
                }
              } while (1 <= f && 0 <= h);
            }
            break
  ...
  function sc(e, t, n, o) {
    ...
    !== "touchmove" && t !== "wheel" || (l = !0), o ? l !== void 0
        ? e.addEventListener(t, n, {
          capture: !0,
          passive: l
        }) : e.addEventListener(t, n, !0) : l !== void 0 ? e.addEventListener(t,
        n, {
          passive: l
    ...
    fa(function () {
      ...
      if (!(t & 7)) {
        ...
        e: {
          ...
          te && te(e, z, A),
          e === "focusout" && (te = z._wrapperState) && te.controlled && z.type
          === "number" && gs(z, "number", z.value)
        }
        ...
        (ne = Hh ? Vh(e, n) : Wh(e, n)) && (A = qo(A, "onBeforeInput"), 0
        < A.length && (M = new Ta("onBeforeInput", "beforeinput", null, n,
            M), U.push({
          event: M,
          listeners: A
        }), M.data = ne))
      ...
      ym = {
        ...
        useReducer: function (e, t, n) {
          ...
          return t = n !== void 0 ? n(t)
            ...
            lastRenderedState: t
          }, o.queue = e, e = e.dispatch = mm.bind(null, je,
              e), [o.memoizedState, e]
        },
        useRef: function (e) {
          var t = Bt();
        ...
        useSyncExternalStore: function (e, t, n) {
          ...
          return l.queue = a, Mc(Oc.bind(null, o, a, e),
              [e]), o.flags |= 2048, so(9, Nc.bind(null, o, a, n, t), void 0,
              null), n
        },
        useId: function () {
          var e = Bt(),
...
` + a.stack
    ...
    if (e !== null) {
      ...
      if (qr(a, o) && e.ref === t.ref) {
        if (rt = !1, t.pendingProps = o = a, (e.lanes & l) !== 0) {
          ...
          return t.lanes = e.lanes, en(e, t, l)
        }
      }
    }
    return Tl(e, t, n, o, l)
  ...
  function lf(e, t, n) {
    ...
    if (o.mode === "hidden") {
      ...
      a !== null ? (o = a.baseLanes | n, t.memoizedState = null) : o = n, ke(
          gr, pt), pt |= o;
    }
  ...
  function df(e, t, n) {
    ...
    if ((h = f) || (h = e !== null && e.memoizedState === null ? !1 : (l & 2)
      ...
      return al(
          ...
          ? (t.mode & 1 ? e.data === "$!" ? t.lanes = 8 : t.lanes = 1073741824
              ...
              ? (o = t.mode, a = t.child, f = {
                mode: "hidden",
                children: f
              }, !(o & 1) && a !== null ? (a.childLanes = 0, a.pendingProps = f)
    ...
    return a = e.child, e = a.sibling, o = kn(a, {
      mode: "visible",
      children: o.children
    }), !(t.mode & 1) && (o.lanes = n), o.return = t, o.sibling = null, e
    !== null && (n = t.deletions, n === null
        ? (t.deletions = [e], t.flags |= 16) : n.push(
            e)), t.child = o, t.memoizedState = null, o
  }
      ...
      for (A in l) {
        if (!o.hasOwnProperty(A) && l.hasOwnProperty(A) && l[A] != null) {
          if (A === "style") {
            ...
            && (c.hasOwnProperty(A) ? a || (a = []) : (a = a || []).push(A,
                null));
          }
        }
      }
      for (A in o) {
        ...
        if (h = l != null ? l[A] : void 0, o.hasOwnProperty(A) && y !== h && (y
          ...
          if (A === "style") {
            if (h) {
              for (f in h) {
                !h.hasOwnProperty(f) || y && y.hasOwnProperty(f)
                || (n || (n = {}), n[f] = "");
              }
              for (f in y) {
            ...
            A === "dangerouslySetInnerHTML" ? (y = y ? y.__html
                : void 0, h = h ? h.__html : void 0, y != null && h !== y
            && (a = a || []).push(A, y)) : A === "children" ? typeof y
                != "string"
                && typeof y != "number" || (a = a || []).push(A, "" + y) : A
                !== "suppressContentEditableWarning" && A
                !== "suppressHydrationWarning" && (c.hasOwnProperty(A) ? (y
                != null && A === "onScroll" && Ee("scroll", e), a || h === y
                || (a = [])) : (a = a || []).push(A, y))
          }
        }
      }
          ...
          if (e = Nn(Ft.current), ti(t)) {
              ...
              if (a.hasOwnProperty(f)) {
                ...
                f === "children" ? typeof h == "string" ? o.textContent !== h
                        && (a.suppressHydrationWarning !== !0 && bo(o.textContent,
                            h, e), l = ["children", h]) : typeof h == "number"
            ...
            === "http://www.w3.org/1999/xhtml" ? n === "script"
                ? (e = f.createElement(
                    ...
                    ? e = f.createElement(n, {
                      is: o.is
                    }) : (e = f.createElement(n), n === "select"
                    && (f = e, o.multiple ? f.multiple = !0 : o.size
                        && (f.size = o.size))) : e = f.createElementNS(e,
                n), e[Ut] = t, e[Xr] = o, mf(e, t, !1, !1), t.stateNode = e;
            e: {
              switch (f = xs(n, o), n) {
                case "dialog":
                ...
                if (h.hasOwnProperty(a)) {
                  ...
                  a === "style" ? ia(e, y) : a === "dangerouslySetInnerHTML"
                      ...
                      === "children" ? typeof y == "string" ? (n !== "textarea"
                          ...
                          e, "" + y) : a !== "suppressContentEditableWarning"
                          && a !== "suppressHydrationWarning" && a
                          !== "autoFocus" && (c.hasOwnProperty(a) ? y != null
                              && a === "onScroll" && Ee("scroll", e) : y != null
                              && W(e, a, y, f))
                }
              }
              switch (n) {
    ...
    for (var o = (e.mode & 1) !== 0; G !== null;) {
      ...
      if (l.tag === 22 && o) {
        ...
        if (!f) {
          ...
          if (gi = f, (Ge = y) && !A) {
            for (G = l; G !== null;) {
              f = G, y = f.child, f.tag === 22
              && f.memoizedState !== null ? jf(l) : y !== null
                  ? (y.return = f, G = y) : jf(l);
            }
          }
          for (; a !== null;) {
  ...
  function Tm(e, t, n, o) {
    ...
    && (vn = null), lh(n.stateNode), it(e, _e()), t !== null) {
  ...
  function vr() {
    if (wn !== null) {
      var e = Sa(ki),
          ...
          n = xe;
      try {
        if (kt.transition = null, xe = 16 > e ? 16 : e, wn === null) {
          var o = !1;
        } else {
            ...
            if (jt(a.value, f)) {
              ...
              for (a = t.child, a !== null && (a.return = t); a !== null;) {
                ...
                if (h !== null) {
                  ...
                  f = a.type === t.type ? null : a.child;
                } else if (a.tag === 18) {
                  if (f = a.return, f === null) {
                    throw Error(s(341));
                  }
                  f.lanes |= n, h = f.alternate, h !== null
                  && (h.lanes |= n), hl(f, n, t), f = a.sibling
                } else {
                  f = a.child;
                }
                if (f !== null) {
  ...
  function ji(e, t, n, o) {
    ...
    return n = Ff(n), t.context === null ? t.context = n
        : t.pendingContext = n, t = Zt(a, f), t.payload = {
      element: e
    }, o = o === void 0 ? null : o, o !== null && (t.callback = o), e = gn(l, t,
        f), e !== null && (Tt(e, l, f, a), ii(e, l, f)), f
  }
...
function Yi(r, i, s) {
  if (s || arguments.length === 2) {
    for (var u = 0, c = i.length, d; u < c; u++) {
      (d || !(u in i)) && (d
      || (d = Array.prototype.slice.call(i, 0, u)), d[u] = i[u]);
    }
  }
...
function ed(r, i, s, u, c, d, p, m, v, x, E, j) {
  for (var O = c - 1, P = c === 0 ? d : [""], I = Jd(P), R = 0, L = 0, V = 0;
      R < u; ++R) {
    for (var F = 0, W = Sr(r, O + 1, O = Kd(L = p[R])), K = r; F < I;
        ++F) {
...
var wg = {
    ...
    ht = {},
    Er = typeof process < "u" && ht !== void 0 && (ht.REACT_APP_SC_ATTR
        || ht.SC_ATTR) || "data-styled",
    tp = "active",
...
var Dg = function () {
    ...
    ud = function (r) {
      for (var i = document.querySelectorAll(Mg), s = 0, u = i.length; s < u;
          s++) {
        var c = i[s];
...
var cp = function (r) {
    ...
    Vg = function () {
      function r(i) {
        this.element = cp(
            i), this.nodes = this.element.childNodes, this.length = 0
      }
    ...
    Wg = function () {
      ...
      return r.prototype.insertRule = function (i, s) {
        return i <= this.length && (this.rules.splice(i, 0,
            s), this.length++, !0)
      }, r.prototype.deleteRule = function (i) {
    ...
    fp = function () {
        ...
        && (ad = !1, ud(this)), Qu(this, function () {
          return function (d) {
            for (var p = d.getTag(), m = p.length, v = "", x = function (j) {
              ...
              }), v += "".concat(I).concat(R, '{content:"').concat(L,
                  '"}').concat(Vu)
            }, E = 0; E < m; E++) {
              x(E);
            }
      ...
      return r.registerId = function (i) {
        ...
        return s === void 0 && (s = !0), new r(Ke(Ke({}, this.options), i),
            this.gs, s && this.names || void 0)
...
function Gg(r) {
  var i, s, u, c = Cr,
      ...
      v = m === void 0 ? ls : m,
      x = function (O, P, I) {
        return I.startsWith(s) && I.endsWith(s) && I.replaceAll(s, "").length
        > 0 ? ".".concat(i) : O
      },
      E = v.slice();
  E.push(function (O) {
    ...
    ey = function () {
      function r(i, s, u) {
        this.rules = i, this.staticRulesId = "", this.isStatic = (u === void 0
            || u.isStatic) && Jg(i), this.componentId = s, this.baseHash = xr(
            Zg, s), this.baseStyle = u, fp.registerId(s)
      }
      ...
      return r.prototype.generateAndInjectStyles = function (i, s, u) {
        ...
        if (this.isStatic && !u.hash) {
          if (this.staticRulesId && s.hasNameForId(this.componentId,
              this.staticRulesId)) {
          ...
          if (x) {
            var P = Pu(v >>> 0);
            s.hasNameForId(this.componentId, P) || s.insertRules(
                this.componentId, P,
                u(x, ".".concat(P), void 0, this.componentId)), c = Un(c, P)
          }
        }
        return c
      }, r
      ...
      var Ve = T.attrs,
          ...
          ee = function (de, ce, ve) {
            for (var pe, ge = Ke(Ke({}, ce), {
              ...
              for (var Rt in bt) {
                ge[Rt] = Rt === "className" ? Un(ge[Rt],
                    bt[Rt]) : Rt === "style" ? Ke(Ke({}, ge[Rt]), bt[Rt])
                    : bt[Rt]
              }
            }
...
const Sd = r => {
      ...
      const s = new Set,
          u = (x, E) => {
            ...
            if (!Object.is(j, i)) {
              const O = i;
              i = E ?? (typeof j != "object" || j === null) ? j : Object.assign({},
                  i, j), s.forEach(P => P(i, O))
            }
          },
          c = () => i,
          m = {
...
const vy = as("string"),
    ...
    [Py, jy, Iy, _y] = ["ReadableStream", "Request", "Response", "Headers"].map(
        zt),
    Ny = r => r.trim ? r.trim() : r.replace(
        /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Oy = (r, i, s, {
    ...
    Wy = r => {
      Cp(r, (i, s) => {
        if (mt(r) && ["arguments", "caller", "callee"].indexOf(s)
            !== -1) {
          return !1;
        }
        const u = r[s];
    ...
    if (I && !L && typeof I == "object") {
      if (_.endsWith(R, "{}")) {
        R = u ? R : R.slice(0, -2), I = JSON.stringify(
            I);
      } else if (_.isArray(I) && t0(I) || (_.isFileList(I) || _.endsWith(R,
              "[]"))
          && (V = _.toArray(I))) {
        return R = Ip(R), V.forEach(function (W, K) {
...
const es = (r, i, s = 3) => {
    ...
    R0 = Ye.hasStandardBrowserEnv ? {
      write(r, i, s, u, c, d) {
        ...
        _.isNumber(s) && p.push(
            "expires=" + new Date(s).toGMTString()), _.isString(u) && p.push(
            "path=" + u), _.isString(c) && p.push("domain=" + c), d === !0
        && p.push("secure"), document.cookie = p.join("; ")
      },
      read(r) {
...
function qn(r, i) {
  ...
  function u(x, E, j, O) {
    return _.isPlainObject(x) && _.isPlainObject(E) ? _.merge.call({
      caseless: O
    }, x, E) : _.isPlainObject(E) ? _.merge({}, E) : _.isArray(E) ? E.slice()
        : E
  }
...
const Mp = r => {
      ...
      return new Promise(function (s, u) {
        ...
        function V() {
          ...
          const W = lt.from(
              ...
              $ = {
                data: !m || m === "text" || m === "json" ? L.responseText
                    : L.response,
                status: L.status,
        ...
        "onloadend" in L ? L.onloadend = V
          ...
          c.timeoutErrorMessage && (K = c.timeoutErrorMessage), u(
              new ie(K, $.clarifyTimeoutError ? ie.ETIMEDOUT : ie.ECONNABORTED,
                  r, L)), L = null
        ...
        && (L.responseType = c.responseType), x && ([O, I] = es(x,
            !0), L.addEventListener("progress", O)), v && L.upload && ([j,
          P] = es(v), L.upload.addEventListener("progress",
            j), L.upload.addEventListener("loadend", P)), (c.cancelToken
            || c.signal) && (E = W => {
      ...
      if (i || s) {
        ...
        const d = function (x) {
          if (!c) {
            ...
            u.abort(E instanceof ie ? E : new Pr(
    ...
    Du = Up && Fp(() => _.isReadableStream(new Response("").body)), ts = {
      stream: Du && (r => r.body)
    };
ds && (r => {
...
const Uu = r => i => {
    ...
    ut = bn(Q0(r => ({
      ...
      logout: () => {
        ...
        i && Dt.getState().updateUserStatus(i), r({
          currentUserId: null
        })
      },
...
function Md({
  ...
  if (m.length > 2) {
    ...
    return g.jsxs(yd, {
      ...
      onClick: s,
      children: [g.jsx(uy, {
        children: m.filter(E => E.id !== c).slice(0, 2).map(
            (E, j) => g.jsx(cy, {
  ...
  const W = () => {
      ...
      $ = async T => {
        ...
        try {
          ...
          && (se.newEmail = p), v && (se.newPassword = v), (Object.keys(
              se).length > 0 || E) && (H.append("userUpdateRequest",
              new Blob([JSON.stringify(se)], {
...
function Iv({
  ...
  const [c, d] = ue.useState({
        name: "",
        description: ""
      }), [p, m] = ue.useState(""), [v, x] = ue.useState([]), [E, j] = ue.useState(
...
function _v({
  ...
  const [u, c] = ue.useState({
        ...
        isOpen: !1,
        type: null
      }), m = Bn(T => T.channels), v = Bn(T => T.fetchChannels),
      x = Bn(T => T.startPolling), E = Bn(T => T.stopPolling);
  yo(T => T.readStatuses);
...
`,
    vo = bn((r, i) => ({
      ...
      fetchMessages: async s => {
        try {
          ...
          return r({
            messages: u.data,
            lastMessageId: c == null ? void 0 : c.id
          }), d
        } catch (u) {
      ...
      createMessage: async s => {
        try {
          ...
          return await d(s.channelId), r(p => ({
            messages: [...p.messages, c.data]
          })), c.data
        } catch (u) {
    ...
    h1 = r => r < 1024 ? r + " B" : r < 1024 * 1024 ? (r / 1024).toFixed(2)
        + " KB" : r < 1024 * 1024 * 1024 ? (r / (1024 * 1024)).toFixed(2)
        + " MB" : (r / (1024 * 1024 * 1024)).toFixed(2) + " GB";
          ...
          E = ut(P => P.setCurrentUser), {
            ...
            try {
              ...
              console.error("로그인 에러:", I), ((P = I.response) == null ? void 0
                  : P.status) === 401 ? m("아이디 또는 비밀번호가 올바르지 않습니다.") : m(
                  "로그인에 실패했습니다.")
            }
          };
