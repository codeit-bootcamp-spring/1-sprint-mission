...
(
    ...
    CONSTRAINT binary_contents_pkey PRIMARY KEY
(
    id
)
    );
...
(
    ...
    CONSTRAINT users_profile_id_fkey FOREIGN KEY
(
    profile_id
)
    REFERENCES public.binary_contents
(
    id
) MATCH SIMPLE
    ON UPDATE NO ACTION
...
(
    ...
    ON UPDATE NO ACTION
    ON DELETE SET NULL,
    CONSTRAINT fk_channel FOREIGN KEY
(
    channel_id
)
...
(
    ...
    CONSTRAINT read_statuses_channel_id_key UNIQUE
(
    channel_id
),
...
(
    ...
    CONSTRAINT user_statuses_user_id_key UNIQUE
(
    user_id
),
    CONSTRAINT user_statuses_user_id_fkey FOREIGN KEY
(
    user_id
)
    REFERENCES public.users
...
(
    ...
    ON UPDATE NO ACTION
    ON DELETE CASCADE,
    CONSTRAINT fk_message FOREIGN KEY
(
    message_id
)
