...
class ChannelControllerTest {
    ...
    void createChannel_public() throws Exception {
        ...
        given(channelService.createPublicChannel(
                any(PublicChannelCreateRequestDto.class))).willReturn(
                responseDto);
    ...
    void createChannel_private() throws Exception {
        ...
        given(
                channelService.createPrivateChannel(
                        any(PrivateChannelCreateRequestDto.class))).willReturn(
                responseDto);
    ...
    void 공채_채널_유효성_실패() throws Exception {
        PublicChannelCreateRequestDto invalidRequest = new PublicChannelCreateRequestDto("",
                "desc");
    ...
    void updateChannel() throws Exception {
        ...
        given(
                channelService.updateChannel(eq(channelId),
                        any(ChannelUpdateRequestDto.class))).willReturn(
                responseDto);
