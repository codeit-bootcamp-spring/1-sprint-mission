...
class MessageControllerTest {
    ...
    void createMessage() throws Exception {
        ...
        given(messageService.createMessage(ArgumentMatchers.any(),
                ArgumentMatchers.any())).willReturn(
                responseDto);

        MockMultipartFile jsonPart = new MockMultipartFile("messageCreateRequest", "",
                "application/json",
                objectMapper.writeValueAsBytes(request));
        MockMultipartFile attachment = new MockMultipartFile("attachments", "file.txt",
                "text/plain",
    ...
    void updateMessage() throws Exception {
        ...
        given(messageService.updateMessage(ArgumentMatchers.any(),
                ArgumentMatchers.any())).willReturn(
                responseDto);
