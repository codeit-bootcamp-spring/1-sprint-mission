...
class BasicUserStatusServiceTest {
  ...
  private static final Logger logger = LoggerFactory.getLogger(BasicUserStatusServiceTest.class);
  ...
  void createUserStatus_Success() {
    logger.info("==== 사용자 상태 생성 성공 테스트 시작 ====");
    ...
    logger.info("==== 사용자 상태 생성 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void createUserStatus_WithExistingStatus_ThrowsException() {
    logger.info("==== 이미 상태가 있는 사용자에 대한 상태 생성 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 이미 상태가 있는 사용자에 대한 상태 생성 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void createUserStatus_WithNonExistentUser_ThrowsException() {
    logger.info("==== 존재하지 않는 사용자에 대한 상태 생성 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 사용자에 대한 상태 생성 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void findUserStatus_Success() {
    logger.info("==== 사용자 상태 조회 성공 테스트 시작 ====");
    ...
    logger.info("==== 사용자 상태 조회 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void findUserStatus_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 사용자 상태 조회 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 사용자 상태 조회 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void findAllUserStatuses_Success() {
    logger.info("==== 전체 사용자 상태 목록 조회 성공 테스트 시작 ====");
    ...
    logger.info("==== 전체 사용자 상태 목록 조회 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void updateUserStatus_Success() {
    logger.info("==== 사용자 상태 수정 성공 테스트 시작 ====");
    ...
    logger.info("==== 사용자 상태 수정 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void updateUserStatus_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 사용자 상태 수정 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 사용자 상태 수정 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void updateUserStatusByUserId_Success() {
    logger.info("==== 사용자 ID로 상태 수정 성공 테스트 시작 ====");
    ...
    logger.info("==== 사용자 ID로 상태 수정 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void updateUserStatusByUserId_WithNonExistentUserId_ThrowsException() {
    logger.info("==== 존재하지 않는 사용자 ID로 상태 수정 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 사용자 ID로 상태 수정 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void deleteUserStatus_Success() {
    logger.info("==== 사용자 상태 삭제 성공 테스트 시작 ====");
    ...
    logger.info("==== 사용자 상태 삭제 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void deleteUserStatus_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 사용자 상태 삭제 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 사용자 상태 삭제 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
}