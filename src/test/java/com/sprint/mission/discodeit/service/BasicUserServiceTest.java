    ...
    void 유저_생성_실패_필수값누락() {
        assertThrows(InvalidUserInputException.class,
                () -> basicUserService.createUser(
                        new UserCreateRequestDto(null, "test@naver.com", "1234"),
                        null));
        assertThrows(InvalidUserInputException.class,
                () -> basicUserService.createUser(new UserCreateRequestDto("테스터", null, "1234"),
                        null));
        assertThrows(InvalidUserInputException.class,
                () -> basicUserService.createUser(
                        new UserCreateRequestDto("테스터", "test@naver.com", null),
                        null));
    }
