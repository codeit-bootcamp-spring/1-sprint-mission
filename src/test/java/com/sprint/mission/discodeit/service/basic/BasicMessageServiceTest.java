...
class BasicMessageServiceTest {
  ...
  private static final Logger logger = LoggerFactory.getLogger(BasicMessageServiceTest.class);
  ...
  void createMessage_WithNonExistentChannel_ThrowsException() {
    logger.info("==== 존재하지 않는 채널에 메시지 생성 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 채널에 메시지 생성 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void createMessage_WithNonExistentAuthor_ThrowsException() {
    logger.info("==== 존재하지 않는 작성자로 메시지 생성 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 작성자로 메시지 생성 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void findMessage_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 메시지 조회 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 메시지 조회 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void findAllByChannelId_Success() {
    logger.info("==== 채널별 메시지 목록 조회 성공 테스트 시작 ====");
    ...
    logger.info("==== 채널별 메시지 목록 조회 성공 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void updateMessage_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 메시지 수정 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 메시지 수정 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
  ...
  void deleteMessage_WithNonExistentId_ThrowsException() {
    logger.info("==== 존재하지 않는 메시지 삭제 시도 시 실패 테스트 시작 ====");
    ...
    logger.info("==== 존재하지 않는 메시지 삭제 시도 시 실패 테스트 종료 ====");
    System.out.println("\n");
  }
}