...
public class ChannelIntegrationTest {
    ...
    void 공개채널_2_생성_조회_1수정_조회_2삭제_조회_() throws Exception {
        // 채널 1 생성
        PublicChannelCreateRequestDto req1 = new PublicChannelCreateRequestDto("channel-1",
                "desc-1");
        ...
        // 채널 2 생성
        PublicChannelCreateRequestDto req2 = new PublicChannelCreateRequestDto("channel-2",
                "desc-2");
