...
public class UserIntegrationRestTemplateTest {
  ...
  void 사용자_시나리오_통합테스트() throws Exception {
    ...
    // 3. 유저 정보 수정 (김철수)
    UserUpdateRequestDto updateRequest = new UserUpdateRequestDto("김철수", "kim@test.com", "1234");
    ...
    try {
      restTemplate.postForEntity(getBaseUrl("/api/auth/login"), failedLoginRequest, String.class);
